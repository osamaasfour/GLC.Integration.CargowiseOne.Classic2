namespace GLC.Integration.CargowiseOne.Classic2.Schemas._856.Tractor {
    ...
    public sealed class TransformShipmentToTractor856 : global::Microsoft.XLANGs.BaseTypes.TransformBase {
              ...
              <xsl:for-each select=""//s0:CommercialInvoiceLineCollection"">
                <xsl:for-each select=""s0:CommercialInvoiceLine"">
                  ...
                  <xsl:if test=""$varcommerciallnk=$varcommlink"">
                    ...
                    <xsl:value-of select=""userCSharp:setpackqtycnt(ScriptNS0:Get945convPCE($varProdcode,userCSharp:replacefunc(s0:PackedQuantity/text())))""/>
                  </xsl:for-each>
                </xsl:for-each>
              </xsl:for-each>
            </xsl:for-each>
